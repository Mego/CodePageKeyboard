...
jellytable = (
    '\xa1\xa2\xa3\xa4\xa5\xa6\xa9\xac\xae\xb5\xbd\xbf\u20ac\xc6\xc7'
    '\xd0\xd1\xd7\xd8\u0152\xde\xdf\xe6\xe7\xf0\u0131\u0237\xf1\xf7\xf8\u0153'
    '\xfe !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`ab'
    'cdefghijklmnopqrstuvwxyz{|}~\xb6\xb0\xb9\xb2\xb3\u2074\u2075\u2076\u2077'
    '\u2078\u2079\u207a\u207b\u207c\u207d\u207e\u0181\u0187\u018a\u0191\u0193'
    '\u0198\u2c6e\u019d\u01a4\u01ac\u01b2\u0224\u0253\u0188\u0257\u0192\u0260'
    '\u0266\u0199\u0271\u0272\u01a5\u02a0\u027c\u0282\u01ad\u028b\u0225\u1ea0'
    '\u1e04\u1e0c\u1eb8\u1e24\u1eca\u1e32\u1e36\u1e42\u1e46\u1ecc\u1e5a\u1e62'
...
supported_pages = [
 ...
 'cp1258', 'cp424', 'cp437', 'cp500', 'cp720', 'cp737', 'cp775', 'cp850',
 'cp852', 'cp855', 'cp856', 'cp857', 'cp858', 'cp860', 'cp861', 'cp862',
 'cp863', 'cp864', 'cp865', 'cp866', 'cp869', 'cp874', 'cp875', 'iso8859_1',
...
def changePage(ev):
    global codepage
    global codepages
    if ev.target.value in codepages:
        codepage = codepages[ev.target.value]
    else:
        codepage = bytes(range(256)).decode(ev.target.value)
    loadButtons()
